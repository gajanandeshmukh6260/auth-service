package com.happiest.assignment.authservice.config;

import com.happiest.assignment.authservice.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .and()
                .authorizeHttpRequests().antMatchers("/auth/adminProfile").authenticated()
                .and()
                .sessionManagement()
